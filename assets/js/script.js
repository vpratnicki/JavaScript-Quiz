...
var questions = [
  ...
  {
    question:
      "String values must be enclosed within ___ when beging assigned to variables.",
    options: [
...
function answerQuestion() {
  //do answer question things here
  qIndex++;
  if (qIndex < questions.length) {
    askQuestion();
  }
  else {
    console.log('finisehd at inex ' + qIndex)
  }
}
